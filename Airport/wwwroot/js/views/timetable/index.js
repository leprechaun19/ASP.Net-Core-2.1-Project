...
$(document).ready(function () {
    dataTable = $('#grid').DataTable({
        ...
        "columns": [
            { "data": "flightTime" },
            { "data": "mondayTimeTable" },
            { "data": "tuesdayTimeTable" },
            { "data": "wednesdayTimeTable" },
            { "data": "thursdayTimeTable" },
            { "data": "fridayTimeTable" },
            { "data": "saturdayTimeTable" },
            { "data": "sundayTimeTable" },
